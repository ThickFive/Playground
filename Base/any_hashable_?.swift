/*	FILEPATH = "./Base/any_hashable_?.swift"
 *	AnyHashable?
    //  error: cannot convert value of type 'HashableKey' to specified type 'AnyHashable'
    //  the same code in `./Base/any_hashable.swift` has no error ?
    Test.run {
